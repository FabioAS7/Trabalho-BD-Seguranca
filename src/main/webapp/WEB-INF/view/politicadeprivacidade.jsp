...
<head>
    ...
    <link rel="shortcut icon" href="../../assets/protecao-de-dados.ico" type="image/x-icon">
</head>
...
<body>
    ...
    <p>
        <span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do EmpresaSegura
            respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a
                href="https://empresasegura.com.br">EmpresaSegura</a>, e outros sites que possuímos e operamos.
        </span>
    </p>
    ...
    <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da informação
            que o EmpresaSegura oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
    <ul>
        ...
        <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e lógicos
                (softwares) do EmpresaSegura, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
    ...
    <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;18 May 2025 15:31</span></p>
</body>
